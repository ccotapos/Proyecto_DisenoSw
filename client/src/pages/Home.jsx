    ...
    <div className="text-center py-16 md:py-24">
      ...
      <div className="max-w-3xl mx-auto px-4 mb-16">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          {/* Botón secundario: Lleva a Horas Extra */}
      ...
      <div className="grid md:grid-cols-3 gap-8 px-4 max-w-6xl mx-auto">
        ...
        {/* Tarjeta 3: Horas Extra (CORREGIDA) */}
        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border-t-4 border-brand-secondary text-left group">
          <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">💰</div>
          {/* Usamos la nueva clave 'overtime' para que el título sea correcto */}
          <h3 className="font-bold text-2xl mb-3 text-brand-secondary">{t('home.cards.overtime')}</h3>
          <p className="text-brand-dark leading-relaxed">{t('home.cards.overtime_desc')}</p>
        </div>
